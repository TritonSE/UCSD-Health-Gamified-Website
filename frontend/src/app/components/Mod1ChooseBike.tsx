...
export default function Mod1ChooseBike() {
  return (
    <div className={styles.container}>
        ...
        <p className={styles.description}>Why choose an E-bike? E-bikes are a fun and eco-friendly way to get around. They can help you:</p>
        <div className={styles.cardContainer}>
            ...
            <CardSlide title="SAVE ACTIVE" content="Enjoy the benefits of cycling while getting a boost from the electric motor."/>
        </div>
    </div>
  );
}
