...
import { Question, Quiz } from "../quiz_components/Quiz";

import styles from "./FinalTest.module.css";

export const FinalTest = () => {
  const finalTestQuestions: Question[] = useMemo(
    () => [
      {
...
// Styles for FinalTest (can be in a separate FinalTest.module.css)
// For now, inline or to be created later.
